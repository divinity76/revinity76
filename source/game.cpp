...
if (text == "!credits") {
     ...
     if (text == "!website") {
        ...
        if (text == "!info") {
                ...
                text << "\nIndividual player save time (In minutes): "; text << g_config.getGlobalString("playersave", "");
...
#endif //YUR_RINGS_AMULETS
if(player && player->items[SLOT_FEET] && player->items[SLOT_FEET]->getID() == ITEM_SOFT_BOOTS){
