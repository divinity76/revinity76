...
place1 = {x=363, y=332, z=7}
place2 = {x=364, y=332, z=7}
place3 = {x=365, y=332, z=7}
...
doPlayerSendCancel(cid,"You insert one platinum coin.")
else
...
if piece1 >= 1 and piece1 <= 40 and piece2 >= 1 and piece2 <= 40 and piece3 >= 1 and piece3 <= 40 then
	doPlayerSendTextMessage(cid,22,"You won 2 Platinum Coins.")
	doPlayerAddItem(cid,2152,2)	--change prize here
	end
...
if piece1 >= 77 and piece1 <= 79 and piece2 >= 77 and piece2 <= 79 and piece3 >= 77 and piece3 <= 79 then
	doPlayerSendTextMessage(cid,22,"You won 25 Platinum Coins!")
	doPlayerAddItem(cid,2152,25) --change prize here
	end
if piece1 == 80 and piece2 == 80 and piece3 == 80 then
	doPlayerSendTextMessage(cid,22,"JACKPOT! You won 1 Crystal Coin!")
	doPlayerAddItem(cid,2160,1) --change prize here
	end
return 0
end	